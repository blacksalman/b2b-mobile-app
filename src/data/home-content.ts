...
// --- Prescription groups (line 1514) — all open the 'Health supplement' category, verbatim ---
export const prescriptionGroups = [
  { name: 'Grahani', count: 5, tint: '#DCF5E9', icon: '#25A567', glyph: '∿' },
  { name: 'Yakrith Vikara', count: 2, tint: 'rgba(232,135,90,.14)', icon: '#E8875A', glyph: '❧' },
  { name: 'Prameha', count: 5, tint: 'rgba(74,143,199,.14)', icon: '#4A8FC7', glyph: '◍' },
  { name: 'Tvak Roga', count: 7, tint: 'rgba(155,127,206,.16)', icon: '#9B7FCE', glyph: '⛨' },
  { name: 'Pravahi Atisara', count: 2, tint: 'rgba(225,92,109,.14)', icon: '#E15C6D', glyph: '◐' },
  { name: 'Ashmari', count: 2, tint: '#DCF5E9', icon: '#0F3D2E', glyph: '⚕' },
];
...
// --- Promo banner carousel (line 1453) — nav targets ported verbatim, including the
// "Fruit & Vegetables" category target that doesn't exist in this skin's CATS list (leftover from
// the "Various" grocery template the AyurvedaOne skin was derived from — kept as-is per fidelity rule).
export const promoBanners = [
  { eyebrow: 'BULK PRICING', title: 'Save more on 3+ cases', sub: 'Automatic tier discounts applied at checkout', tint: '#DCF5E9', accent: '#0F3D2E', targetCategory: 'Fruit & Vegetables' },
